...
const MainContainer = () => {
  ...
  // src/components/Layout/MainContainer.jsx (continued)
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="fade-in">
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-6 slide-up">{renderActiveForm()}</div>
          </div>
        </div>
      ...
      <FloatingActionButton onClick={handleExportPDF} loading={isExporting} />
    </div>
  );
};
